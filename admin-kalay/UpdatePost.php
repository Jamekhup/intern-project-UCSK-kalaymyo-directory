...
if (empty($_SESSION['admin'])) {
  ...
  if (isset($_GET['id'])) {
    ...
    $id=$_GET['id'];
    $edit="SELECT * FROM post WHERE id='$id'";
          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
             <div class="text-center">
              ...
              <form id="formid" action="UpdatePostProcess.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                <input class="form-control" type="text" placeholder="Name" name="Name" value="<?php echo $post['Name']; ?>">
                 </div>
                <div class="form-group">
                <input class="form-control" type="text" placeholder="Address" name="Address" value="<?php echo $post['Address']; ?>">
                </div>
                 <div class="form-group">
                <input class="form-control" type="text" placeholder="PhoneNumber" name="PhoneNumber" value="<?php echo $post['PhoneNumber']; ?>">
                </div>
                  <div class="form-group">
                  
                   
                    <select class="form-control" name="CategoryName" value="<?php echo $post['Category']; ?>">
                       <?php 
